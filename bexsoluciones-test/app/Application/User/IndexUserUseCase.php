...
final class IndexUserUseCase
{
    ...
    public function __invoke(?int $offset = null, ?string $email = null, ?string $name = null, ?int $identification = null): array
    {
        $criteria = UserSearchCriteria::create($offset, $email, $name, $identification);
