...
final class User
{
    private function __construct(
        ...
        private TypeDocumentId $type_document_id,
    ...
    public static function create(
        ...
        TypeDocumentId $type_document_id,
    ...
    public function typeDocumentId(): TypeDocumentId
    {
    ...
    public function updateTypeDocumentId(string $type_document_id): self
    {
        $this->type_document_id = TypeDocumentId::fromPrimitives($type_document_id);
        return $this;
    }
    ...
    public function asArray(): array
    {
        return [
            ...
            'type_document_id' => $this->typeDocumentId()->value(),
